...
declare -a featureMode="0" # Specified M (M is the total number of features - in this case 9)
declare -a featureSplits=("2") # Number of features allowed considered for each split
