...
declare -a lambdas=("0.001" "0.01") # "0.01" "0.1")
declare -a lossFuns=("LogisticLoss" "SquaredLoss" "HingeLoss" "PerceptronLoss") # "SquaredLoss")
declare -a regulars=("ZeroRegularizer" "L2Regularizer") # "L2Regularizer")
declare -a regParams=("0.001" "0.01") # "0.01")
